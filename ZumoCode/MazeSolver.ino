...
// while manually controlling the robot, look for people and avoid overrunning lines
void checkForlineAndPeople(){

    readSensor();

    if(lineSensorValues[1] >= 100  || lineSensorValues[0] >=100 || lineSensorValues[2] >=100){
